...
router.post('/', async (req, res) => {
  try {
    ...
    const message = err.message?.includes('generated by VEO')
      ? 'Video reference must be a Veo-generated video. Only videos created by Veo can be used for scene extension.'
      : err.message;
